...
public class ActivityLoaderActivity extends Activity {
	...
	private void startImplicitActivation() {
        ...
        Intent baseIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.android.com"));
		
		// TODO - Create a chooser intent, for choosing which Activity
		// will carry out the baseIntent
		// (HINT: Use the Intent class' createChooser() method)
		Intent chooserIntent = Intent.createChooser(baseIntent, "View url");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == GET_TEXT_REQUEST_CODE && resultCode == RESULT_OK) {
            mUserTextView.setText(data.getStringExtra(ExplicitlyLoadedActivity.KEY_CUSTOM_TEXT));
        }
